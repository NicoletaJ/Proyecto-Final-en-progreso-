    ...
    return (
        <div>
            ...
            <section className="container text-center informacion-post-contador pt-5">
                <h5 className='pt-3 pb-3'>REALIZAMOS OBRAS CON EXCELENTES RESULTADOS</h5>
            ...
            <section className="ejemplo-proyectos my-5">
                <div className="row align-items-center pt-5">
                    ...
                    <ProjectItem
                        ...
                        link="/project/1"  // Enlace a la misma ruta del project con ID 1
                    />
                    ...
                    <div className="col-md-4">
                        <ProjectItem
                            ...
                            link="/project/2" // Enlace correspondiente al id 2
                        />
                    </div>
                    <div className="col-md-4">
                        <ProjectItem
                            ...
                            link="/project/3" // Enlace correspondiente al id 3
                        />
                    </div>
                </div>
            </section>
